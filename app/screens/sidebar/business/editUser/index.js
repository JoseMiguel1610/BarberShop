        ...
        >
            ...
            <View style={{ paddingHorizontal: 20,  }}>
                ...
                <View style={{ marginTop: 20, marginBottom: 20 }}>
                    <Search_box fontSz={12} place={'Ingrese el correo electrónico de un usuario'} bc={'#F1E9C4'} col_text={"#3b3b3b"} value={email_for_send} onChange={setemail_for_send} ></Search_box>
                </View>
