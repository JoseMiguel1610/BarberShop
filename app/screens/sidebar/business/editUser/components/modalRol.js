...
function ModalRol({ isModalVisible, setrol, setinforol, toggleModal, onBackButtonPress,
    ...
    return (
        <Modal isVisible={isModalVisible} style={styles.modal} onBackButtonPress={onBackButtonPress} >
            <View style={styles.container}>
                ...
                <FlatList
                    data={items}
                    renderItem={({ item }) => <CardRol setrol={setrol} setinforol={setinforol} toggleModal={toggleModal} data={item} />}
